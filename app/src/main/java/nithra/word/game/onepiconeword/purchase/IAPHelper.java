...
public class IAPHelper {
    ...
    public IAPHelper(Context context, IAPHelperListener IAPHelperListener, List<String> skuList) {
        ...
        if (!mBillingClient.isReady()) {
            System.out.println("---test BillingClient: Start connection...");
    ...
    private void startConnection() {
        mBillingClient.startConnection(new BillingClientStateListener() {
            ...
            public void onBillingSetupFinished(BillingResult billingResult) {
                ...
                System.out.println("---test billingResponseCode :"+billingResponseCode);
    ...
    public void getSKUDetails(List<String> skuList) {
        System.out.println("---test skuList :"+skuList);
        ...
        mBillingClient.querySkuDetailsAsync(skuParams, new SkuDetailsResponseListener() {
            ...
            public void onSkuDetailsResponse(BillingResult billingResult, List<SkuDetails> skuDetailsList) {
                System.out.println("---test getResponseCode :"+billingResult.getResponseCode());
                System.out.println("---test skuDetailsList :"+skuDetailsList);
                if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK && skuDetailsList != null) {
                    for (SkuDetails skuDetails : skuDetailsList) {
                        skuDetailsHashMap.put(skuDetails.getSku(), skuDetails);
                    }
                    System.out.println("---test IAPHelperListener :"+IAPHelperListener);
                    System.out.println("---test skuDetailsHashMap :"+skuDetailsHashMap);
                    if (IAPHelperListener != null)
